...
def top_states(df,year):

    df1=df.copy()

    df1=df1[(df1['level']=='State')*(df1['year']==year)]
    ...
    fig=px.bar(df2,x='district_pincode_name',y=['transaction_amount','transaction_count'],barmode='group',
               labels={'value':'Amount/Count','district_pincode_name':'State','transaction_amount':'Transaction Amount','transaction_count':'Transaction Count'},
